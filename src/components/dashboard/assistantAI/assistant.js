...
import { TextField, Button, Paper, Grid, Divider, Typography, Box, Avatar, CircularProgress, List, ListItem, ListItemText } from "@mui/material";
import axios from "axios";
import { WindIcon } from "../../../utils/icons/icons";
        ...
        <Grid width='100%' display='flex' justifyContent='center' flexDirection='row'>
            ...
            <Grid sx={{ bgcolor: "#FFF", p: 2, borderRadius: 4, }} xs={12} sm={4}>
                <Box display='flex' flexDirection='row'>
                    ...
                    <Typography variant='h6' sx={{ my: 1.5 }}>FAQ</Typography>
                </Box>
                <Divider variant='fullWidth' sx={{ mb: 1.5 }}></Divider>
                <Box sx={{ border: 0, borderColor: '#FFC107' }}>
                    <Button variant="text" color="warning" fullWidth onClick={handleClearChat}>Clear Chat</Button>
                    <Divider sx={{mb:2}}/>
