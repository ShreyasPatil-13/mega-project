...
export default function CompanyDashboard() {
    ...
    const tabs = [
        ...
        { label: 'Market', icon: <HomeIcon />, divide: true },
        { label: 'Weather Details', icon: <WeatherIcon />, level: 'Tools & Info', },
    ...
    const drawer = (
        <List>
            {tabs.map((tab, index) => (
                <>
                    <ListSubheader sx={{ fontWeight: '550', ml: -1, my: 1 }}>{tab.level}</ListSubheader>
    ...
    return (
        <Box sx={{ display: 'flex' }}>
            ...
            <Box component="main" sx={{ flexGrow: 1, my: 2, mr: 3, ml: 0,  }}>
                <Toolbar />
